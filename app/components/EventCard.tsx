...
export default function EventCard({
  ...
  return (
    <div className="flex overflow-hidden rounded-lg bg-[#464646] text-white bg-gray-200/10 rounded-lg inline-flex justify-start items-start overflow-hidden">
      ...
      {/* Event Details */}
      <div className="self-stretch self-stretch px-4 py-2 inline-flex flex-col justify-between items-start">
        {/* Title */}
        {/* <h3 className="text-xl font-medium leading-loose font-['Poppins'] tracking-tight">
          {title}
        </h3> */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="self-stretch justify-start text-neutral-0 text-base font-normal font-['Poppins'] leading-normal tracking-tight">
            {date}
          </div>
        </div>
